...
> = ({ params: { channelName, eventId } }) => {
  ...
  return (
    <main>
      <AppLayout.Header.MakeAuthedHeaderTemporailyMade height="4" />
              ...
              <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <CardContent>
                  <Flex className="px-2" gap="2">
                    <Flex
                      className="h-auto w-[390px] rounded-lg px-[1.5rem] pb-8 shadow-lg"
                      direction="column"
                      gap="2"
                    >
                      <Flex
                      ...
                      <Avatar className="relative h-[469px] w-[342px] rounded-lg">
                        ...
                        <Flex
                          className="absolute inset-x-0 bottom-0 rounded-b-lg bg-gradient-to-t from-black to-transparent px-[1.5rem] pb-[1.5rem] pt-[4rem]"
                          justify="end"
                        >
                          <Text
