...
export default function Home() {
  return (
    <main className="font-pretendard">
      <nav className=" border-b py-[6px] border-b-grey-100">
      ...
      <section className="flex flex-col items-center">
        <h2 className="text-[56px] leading-[72px] font-bold tracking-[-0.84px] mt-[120px] text-center">
          이벤트 예약, 내 웹사이트에서 <br />
          <span className="text-primary-2-300">직접 받으세요</span>
        </h2>
        <p className="text-grey-500 text-xl font-medium text-center mt-6">
          착착은 2가지 <span className="text-primary-2-300">Widget SDK</span>를
          제공하여
          <br /> 나에게 맞는 솔루션으로
          <br /> 이벤트를 직접 관리할 수 있어요.
        </p>

        <figure className="bg-grey-50 flex flex-row-reverse mt-14 rounded-3xl">
          <Image
        ...
        <figure className="bg-grey-50 flex flex-row-reverse mt-14 rounded-3xl overflow-hidden">
          <div className="relative min-w-[740px]">
            <Image
            ...
            <Image
              ...
              width={436}
              height={675}
              className="absolute top-[26px] right-[52px]"
            />
          </div>
      ...
      <section className="flex flex-col items-center">
        <h2 className="text-[56px] leading-[72px] font-bold tracking-[-0.84px] mt-[120px] text-center">
          다양한 커스터마이징으로 <br /> 브랜드를{" "}
          <span className="text-primary-2-300">빛내보세요.</span>
        </h2>

        <p className="text-center text-xl font-medium text-grey-500 mt-6">
          착착에서{" "}
          <span className="text-primary-2-300">
            브랜드 로고, 이미지, 프라이머리 컬러
          </span>
        ...
        <figure className="bg-grey-50 flex flex-row-reverse mt-14 rounded-3xl overflow-hidden">
          <div className="relative min-w-[740px]">
            ...
            <Image
              ...
              width={254}
              height={505}
              className="absolute top-0 right-[86px]"
            />
          </div>
          <figcaption className="p-6 min-w-[460px] mb-[120px]">
            <span className="font-medium text-lg leading-[22px] rounded-lg bg-[#e6e2ff] px-3 py-2 inline-block text-[#3D02E3]">
      ...
      <section className="flex flex-col items-center my-[120px]">
        ...
        <p className="text-center text-xl font-medium text-grey-500 mt-6">
          ...
          <span className="text-primary-2-300">마케팅 기회로 전환하세요.</span>
        </p>

        <figure className="bg-grey-50 flex flex-row-reverse mt-14 rounded-3xl overflow-hidden max-h-[480px]">
          <div className="relative min-w-[740px]">
            <Image
      ...
      <section className="flex flex-col items-center bg-grey-800 py-[120px]">
